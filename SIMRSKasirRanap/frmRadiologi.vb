...
Public Class frmRadiologi
    ...
    Protected Sub SkinButton()
        ...
        tableColorButton.Name = "BlueFlat4"
...
#Region "Control"
    Protected Sub LoadNoDaftar()
        Dim columns As GridColumnCollection = sgRad.PrimaryGrid.Columns
        Dim context As Object = Nothing
        dsetRadiolog = Radiolog.DataRadiologiPasien(Me.txtNoDaftar.Text.Trim)

        sgRad.PrimaryGrid.DataSource = GetPasienDataSet()
        sgRad.PrimaryGrid.DataMember = "Pasien"
    ...
    Protected Sub UpdateStatus()
        ...
        Using cn As New MySqlConnection With {.ConnectionString = ConnectionTemp.con}
            Using cmd As New MySqlCommand With {.Connection = cn}
                cmd.CommandText = Radiolog.SelectNoRadiologiScript()
                cmd.Parameters.AddWithValue("@noRegistrasiRadiologiRanap", Label11.Text)

                da.SelectCommand = cmd

                cmd.CommandText = Radiolog.UpdateStatusRadiologiRanap
                ...
                da.Update(ds, "Pasien")
                dsetRadiolog.Tables("Pasien").AcceptChanges()
            End Using
        End Using
    End Sub
#End Region
    Private Sub frmRadiologi_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If tableColorButton.Name <> "BlueFlat4" Then SkinButton()
        ...
        sgRad.DefaultVisualStyles.GridPanelStyle.Background.Color1 = SystemColors.Control
        sgRad.PrimaryGrid.DefaultVisualStyles.CellStyles.Default.TextColor = Color.Black
        sgRad.PrimaryGrid.UseAlternateRowStyle = False

        sgRad.PrimaryGrid.UseAlternateColumnStyle = True
        sgRad.PrimaryGrid.ShowRowHeaders = False
        sgRad.PrimaryGrid.ColumnAutoSizeMode = DevComponents.DotNetBar.SuperGrid.ColumnAutoSizeMode.Fill
        btnProses.Enabled = False
        AddHandler sgRad.DataBindingComplete, AddressOf sgRad_DataBindingComplete
    End Sub
    ...
    Private Sub txtNoRM_TextChanged(sender As Object, e As EventArgs) Handles txtNoRM.TextChanged
        ...
        Else
            ...
            sgRad.PrimaryGrid.DataSource = bsRadiolog
    ...
    Private Sub txtNoRM_KeyDown(sender As Object, e As KeyEventArgs) Handles txtNoRM.KeyDown
        ...
        End If
    End Sub
    Private Sub frmRadiologi_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
    ...
    Private Function TotalRows(ByVal rows As IEnumerable(Of GridElement)) As Double
        ...
        For Each item As GridContainer In rows
            If TypeOf item Is GridRow Then
                ...
                Dim pp As String = CStr(row("No.Registrasi Radiologi").Value.ToString)
                Label11.Text = pp
            End If
    ...
    End Sub
    Private Sub sgRad_DataBindingComplete(sender As Object, e As GridDataBindingCompleteEventArgs) Handles sgRad.DataBindingComplete
    ...
    Private Sub btnProses_Click(sender As Object, e As EventArgs) Handles btnProses.Click
        If dsetRadiolog IsNot Nothing Then
            UpdateStatus()
        End If
    End Sub
End Class