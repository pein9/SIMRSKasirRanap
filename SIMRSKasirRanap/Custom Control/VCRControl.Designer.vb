Namespace SuperGridDemo
	Partial Public Class VcrControl
		...
		Private Sub InitializeComponent()
            ...
            ' label
            ' 
            Me.vlabel.Dock = DockStyle.Fill
            Me.vlabel.Location = New Point(68, 0)
            Me.vlabel.Name = "label"
            Me.vlabel.Size = New Size(174, 36)
            Me.vlabel.TabIndex = 4
            Me.vlabel.TextAlign = ContentAlignment.MiddleCenter
            ' 
            ' leftPanel
            ' 
